...
public class App2Activity extends AppCompatActivity {
    ...
    private class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            final int time = Integer.parseInt(params[0]);
            try {

                final int percentage = 100/time;

                for ( i = 0; i < 101; i=i+percentage) {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(getApplicationContext(), "İşem Tamamlandı", Toast.LENGTH_LONG).show();
        }
        ...
        protected void onPreExecute() {
           //ilk burasi kosulur
            super.onPreExecute();
            progressDialog = new ProgressDialog(App2Activity.this);
        ...
        protected void onProgressUpdate(String... percentage) {
            ...
            Integer currentProgress = Integer.parseInt(percentage[0]);
